...
const AVATAR_OPTIONS = {
  ...
  eyes: [
    ...
    { id: 'eyes_angry', name: 'Angry/Fierce' },
    { id: 'eyes_sad', name: 'Sad/Shy' },
    { id: 'eyes_star', name: 'Star Idol' },
    { id: 'eyes_heart', name: 'Heartstruck' },
    { id: 'eyes_cyber', name: 'Cyber Slit' },
  ],
  mouth: [
    { id: 'mouth_smile', name: 'Smile' },
    { id: 'mouth_open', name: 'Open (Happy)' },
    { id: 'mouth_sad', name: 'Sad/Pout' },
    { id: 'mouth_cat', name: 'Cat :3' },
    { id: 'mouth_vampire', name: 'Vampire Fangs' },
  ],
  hair: [
    ...
    { id: 'hair_ponytail', name: 'High Ponytail' },
    { id: 'hair_samurai', name: 'Samurai Knot' },
    { id: 'hair_messy', name: 'Messy Hero' },
  ...
  clothes: [
    ...
    { id: 'clothes_ninja', name: 'Ninja Stealth' },
    { id: 'clothes_hoodie', name: 'Oversized Hoodie' },
    { id: 'clothes_armor', name: 'Knight Armor' },
  ],
  accessory: [
    ...
    { id: 'acc_crown', name: 'Floating Crown' },
    { id: 'acc_horns', name: 'Demon Horns' },
    { id: 'acc_goggles', name: 'Steam Goggles' },
    { id: 'acc_eyepatch', name: 'Pirate Patch' },
    { id: 'acc_kitsune', name: 'Kitsune Mask' },
  ],
  decals: [
    ...
    { id: 'decal_freckles', name: 'Cute Freckles' },
    { id: 'decal_star', name: 'Star Tattoo' },
    { id: 'decal_tear', name: 'Tear Drop' },
  ],
  stage: [
    ...
    { id: 'stage_magic', name: 'Magic Circle' },
    { id: 'stage_rocks', name: 'Floating Rocks' },
  ]
}
